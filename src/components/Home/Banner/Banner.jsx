            ...
            <div class="row">
                <div class="col-md-6 text-start mt-5 pt-5">
                    <div className='pt-5 banner'>
                        ...
                        <button ><a className='btn  ps-3 pe-3 p-3 '  target="_blank" href="https://drive.google.com/file/d/16GsHo8Ze-kMyPLB3QuCgTdXXt9bWVAsr/view?usp=sharing"><i class="fas fa-arrow-down"></i> DOWNLOAD RESUME</a></button>
                    </div>
                </div>
